...
def _kpi_card(label, model_name, hist_avg, forecast, risk, risk_color):
    ...
    st.markdown(
        ...
        '>
            ...
            <div style='text-align:right; font-size:0.78rem; color:#6B7280; margin-top:0.2rem;'>🤖 {model_name}</div>
        </div>
        """,
        unsafe_allow_html=True,
    )
...
def PriceForecast():
    ...
    with col2:
        ...
        st.markdown(
            f"<p style='color: #888888; font-size: 0.75rem; margin-top: 0.5rem; text-align: right;'>🤖 {model_name_fancy}</p>",
            unsafe_allow_html=True)
    ...
    with col2:
        ...
        st.markdown(
            f"<p style='color: #888888; font-size: 0.75rem; margin-top: 0.5rem; text-align: right;'>🤖 {model_name_regular}</p>",
            unsafe_allow_html=True)
